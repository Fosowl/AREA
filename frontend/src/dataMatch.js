      ...
      "actions": {
        ...
        "every_day": {
          "hour": {
            ...
            value: undefined,
            description: 'Triggers relative to your timezone settings and defaults to UTC (GMT+00:00) if no preference is set.'
          }
        },
        "every_week": {
          "day": {
      ...
      "reactions": {
        "send_tweet": {
          "text": {
            ...
            value: undefined,
            description: 'Tweet text. @mentions are not allowed. Character Limit is as set by Twitter'
          },
        },
        "follow": {
          "user_to_follow": {
      ...
      "reactions": {
        "send_mail": {
          "to": {
            ...
            pretty_name: "To",
            value: undefined,
            description: 'The email address who you want to send the email. Multiple addresses not allowed'
          },
          "subject": {
            type: types.text,
            pretty_name: "Subject",
